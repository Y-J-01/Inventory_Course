...
{
	GridSlotState = EInv_GridSlotState::Occupide;
	Image_GridSlot->SetBrush(Brush_Occupide);
}

void UInv_GridSlot::SetUnoccupideTexture()
{
	GridSlotState = EInv_GridSlotState::Unoccupide;
	Image_GridSlot->SetBrush(Brush_Unoccupide);
}
